...
class FoodService {
  ...
  Future<List<FoodModel>> fetchMenu() async {
    try {
      final res = await _client.from('menu_items').select();
      return (res as List)
  ...
  static final List<FoodModel> _localMenu = [
    FoodModel(
      id: 'beef-burger',
    ...
    FoodModel(
      ...
      description:
          'Crispy chicken with caramelized onions, cheese, tomato and house sauce on a toasted bun.',
      price: 280,
      discountedPrice: 250,
      rating: 4.8,
      deliveryTime: '40 min',
    ...
    FoodModel(
      ...
      category: 'Italian',
      imageUrl:
          'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=600&auto=format&fit=crop&q=60',
    ),
    FoodModel(
      id: 'shawarma',
      name: 'Shawarma',
      ...
      category: 'Wraps',
      imageUrl:
          'https://images.unsplash.com/photo-1719282431723-9d0f4370d4bc?w=600&auto=format&fit=crop&q=60',
    ),
    FoodModel(
      id: 'lemon-iced-tea',
      name: 'Lemon Iced Tea',
    ...
    FoodModel(
      ...
      category: 'Drinks',
      imageUrl:
          'https://images.unsplash.com/photo-1653542773369-51cce8d08250?w=600&auto=format&fit=crop&q=60',
    ),
    FoodModel(
      id: 'cappuccino',
      name: 'Cappuccino',
      ...
      category: 'Drinks',
      imageUrl:
          'https://plus.unsplash.com/premium_photo-1674327105280-b86494dfc690?w=600&auto=format&fit=crop&q=60',
    ),
    FoodModel(
      id: 'orange-juice',
      name: 'Orange Juice',
      ...
      category: 'Drinks',
      imageUrl:
          'https://images.unsplash.com/photo-1618046364546-81e9d03d39a6?w=600&auto=format&fit=crop&q=60',
    ),
  ];
}
